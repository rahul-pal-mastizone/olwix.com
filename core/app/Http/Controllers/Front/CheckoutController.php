...
class CheckoutController extends Controller
{
    ...
    public function checkout(PaymentRequest $request)
    {
        ...
        // Ensure referral_code from the checkout form is included in the input so
        // order creation in traits/repositories receives and saves it.
        $input['referral_code'] = $request->input('referral_code', null);

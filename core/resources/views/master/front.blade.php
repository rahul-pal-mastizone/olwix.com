...
<footer class="site-footer">
  <div class="container">
    <div class="row">
      <!-- Column 1: Contact Info (33.33% width) -->
      <div class="col-lg-4 col-md-4 col-sm-12">
        <section class="widget widget-light-skin">
          <h3 class="widget-title">{{__('Get In Touch')}}</h3>
          <p class="mb-1" style="white-space: pre-wrap;"><strong>{{__('Address')}}: {{ $setting->footer_address }}</strong></p>
      ...
      <!-- Column 2: Useful Links (33.33% width) -->
      <div class="col-lg-4 col-md-4 col-sm-12">
          ...
          <div class="row gx-5">
            <div class="col-md-6 pe-4">
              <ul>
                ...
                @endif
                @php
                  $pages = DB::table('pages')->wherePos(2)->orWhere('pos', 1)->get();
                  $half = ceil($pages->count() / 2);
                  $firstHalf = $pages->take($half);
                @endphp
                @foreach ($firstHalf as $page)
            ...
            <div class="col-md-6 ps-4">
              <ul>
                @php
                  $secondHalf = $pages->skip($half);
                @endphp
                @foreach ($secondHalf as $page)
                  <li><a href="{{route('front.page', $page->slug)}}">{{$page->title}}</a></li>
                @endforeach
              </ul>
            </div>
      ...
      <!-- Column 3: Newsletter (33.33% width) -->
      <div class="col-lg-4 col-md-4 col-sm-12">
